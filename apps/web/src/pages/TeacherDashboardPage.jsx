  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10">
      <div className="rounded-[2rem] border border-white/70 bg-white/85 p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/85">
        ...
        <h1 className="mt-2 text-3xl font-black">Teaching workspace</h1>
        <p className="mt-2 text-slate-500">Signed in as {user?.name || user?.email || 'teacher'}.</p>

        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {[
            { label: 'Upcoming Tests', value: '—' },
            { label: 'Recent Attempts', value: '—' },
        ...
        <div className="mt-8 flex flex-wrap gap-3 text-sm">
          <Link className="rounded-full border border-slate-300 bg-white px-4 py-2 font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200" to="/manage/catalog">Catalog</Link>
