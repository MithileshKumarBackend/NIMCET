...
const localizedTextSchema = new mongoose.Schema(
  { language: { type: String, default: 'en' }, content: { type: String, required: true } },
  { _id: false },
);
...
const questionSchema = new mongoose.Schema(
  {
    type: {
      type: String,
      enum: ['single_correct_mcq', 'multiple_correct_mcq', 'true_false', 'integer', 'fill_blank', 'paragraph'],
      required: true,
      index: true,
    },
    ...
    subTopic: { type: mongoose.Schema.Types.ObjectId, ref: 'SubTopic', index: true },
    difficulty: { type: String, enum: ['easy', 'medium', 'hard'], default: 'medium', index: true },
    language: { type: String, default: 'en', index: true },
    prompt: { type: String, required: true },
    localizedPrompts: [localizedTextSchema],
    paragraph: String,
    ...
    clonedFrom: { type: mongoose.Schema.Types.ObjectId, ref: 'Question' },
  },
  { timestamps: true },
);
